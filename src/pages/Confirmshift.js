   ...
   <div>
     ...
     <div className={classes.root} style={{marginBottom:'100px'}} >
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <p className="marginTopHome2">Check the shift details and confirm the new shift</p>
        </Grid>
      ...
      <Grid container spacing={0}  >
       ...
       <Grid item xs={6}>
          <h3 style={{marginTop:'-20px',marginLeft:'-10px'}}>Location :</h3>
        </Grid>
        <Grid item xs={6} style={{margin:'0px 0px 10px'}}>
          <p style={{marginTop:'-20px',marginLeft:'-20px'}}>Amager</p>
        </Grid>
         <Grid item xs={6}>
          <h3 style={{marginTop:'-20px',marginLeft:'-45px'}}>Time:</h3>
        </Grid>
        <Grid item xs={6} style={{margin:'0px 0px 10px'}}>
          <p style={{marginTop:'-20px',marginLeft:'15px'}}>10:00 - 15:00</p>
        </Grid>
        <Grid item xs={12}>
      ...
      >
        <Fade in={open}>
          <div className={classes.paperModal}>
            ...
            <p id="transition-modal-description">The following shift has been created and added to the calendar</p>
            <Container maxWidth="sm" style={{marginTop:'-20px'}} >    
